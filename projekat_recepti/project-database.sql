...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(17,'storefront','cijenarecepta'),(21,'storefront','komentari'),(9,'storefront','kontakt'),(7,'storefront','korisnici'),(20,'storefront','korisnik'),(11,'storefront','listazelja'),(12,'storefront','nacinpripreme'),(10,'storefront','pretplatnici'),(16,'storefront','recepti'),(22,'storefront','receptisteps'),(8,'storefront','recepttest'),(18,'storefront','sastojci'),(13,'storefront','videorecepta'),(14,'storefront','vrstajela'),(19,'storefront','vrstaobroka'),(15,'storefront','zdravahrana');
...
--
-- Table structure for table `storefront_komentari`
--

DROP TABLE IF EXISTS `storefront_komentari`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `storefront_komentari` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
  `recept_id` bigint NOT NULL,
  `user_id` bigint NOT NULL,
  `content` longtext NOT NULL DEFAULT (_utf8mb3'Upisite Vas komentar'),
  PRIMARY KEY (`id`),
  KEY `storefront_komentari_recept_id_9a33247e_fk_storefront_recepti_id` (`recept_id`),
  KEY `storefront_komentari_user_id_2f0f885e_fk_auth_user_id` (`user_id`),
  CONSTRAINT `storefront_komentari_recept_id_9a33247e_fk_storefront_recepti_id` FOREIGN KEY (`recept_id`) REFERENCES `storefront_recepti` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `storefront_komentari`
--

LOCK TABLES `storefront_komentari` WRITE;
/*!40000 ALTER TABLE `storefront_komentari` DISABLE KEYS */;
INSERT INTO `storefront_komentari` VALUES (1,'2022-05-29',2,4,'Test komentar'),(2,'2022-05-29',2,1,'Testiramo trenutnog usera');
/*!40000 ALTER TABLE `storefront_komentari` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `storefront_korisnik` VALUES (1,'profile_avatar/panth_s0zAYRQ.png',1),(2,'',4),(4,'profile_avatar/akali.png',6);
...
--
-- Table structure for table `storefront_receptisteps`
--

DROP TABLE IF EXISTS `storefront_receptisteps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `storefront_receptisteps` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `body` longtext,
  `recept_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `storefront_receptist_recept_id_e4b18b1d_fk_storefron` (`recept_id`),
  CONSTRAINT `storefront_receptist_recept_id_e4b18b1d_fk_storefron` FOREIGN KEY (`recept_id`) REFERENCES `storefront_recepti` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `storefront_receptisteps`
--

LOCK TABLES `storefront_receptisteps` WRITE;
/*!40000 ALTER TABLE `storefront_receptisteps` DISABLE KEYS */;
INSERT INTO `storefront_receptisteps` VALUES (1,'<p>Prvi korak test</p>',2);
/*!40000 ALTER TABLE `storefront_receptisteps` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-31 16:28:46
