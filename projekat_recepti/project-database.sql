...
CREATE TABLE `storefront_recepti` (
  ...
  `broj_osoba` varchar(20) NOT NULL,
  `opis_jela` longtext NOT NULL DEFAULT (_utf8mb3'placeholder'),
  `ukupno_vrijeme_pripreme` int NOT NULL,
  `vrijeme_pripreme` int NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `storefront_recepti` VALUES (2,'Francuski Tost','slike/francuski-tost2_PeoGdoN.jpg','2','2022-03-09',150,'2',5,4,1,'1','Francuski tost često nazivaju pohanim kruhom, no iako su glavne namirnice iste, način pripreme i serviranje se razlikuju. Izvrsno se slaže sa svježim, smrznutim i konzerviranim voćem, te jogurtom i pekmezima. Ideja za slatke kombinacije ne nedostaje, a u nastavku pročitajte tajne pripremanja i recept za najfiniji francuski tost.',10,5),(3,'Sendvic sa jajima i lososom','slike/Sendvič-s-lososom.jpg','3','2022-03-15',200,'3',5,4,4,'1','Osnovni sastojci koji vam trebaju su, naravno, sir, kruh i maslac. Šnite kruha premažite maslacem s vanjske strane, između posložite sve sastojke i sendvič zagrijte na odabrani način. Što se ‘punjenja’ tiče, pustite mašti na volju! Najidealnije su topive vrste sira, mozzarella, gouda ili možda tilzit, kruh možete odabrati u integralnim varijantama ili potpuno bijeli ako baš nimalo ne želite paziti na kalorije.',25,15),(4,'Tostirani sendvic sa rastopljenim sirom','slike/Sendvič-sa-sirom.jpg','5','2022-02-08',180,'2',5,4,1,'1','Tost sa sirom jedan je od najlakše izvedivih recepata. Čak vam nije potreban ni toster – ovaj sendvič može se zapeći u tavici ili pećnici, kako god vam je lakše.',10,5),(5,'Zeleni tost sa gljivama','slike/Sendvič-jaje-i-avokado.jpg','5','2022-02-08',87,'3',5,4,1,'1','Ovaj sendvič spaja nekoliko odličnih sastojaka – raženi kruh, avokado, losos, jaja i klice koji zajedno zvuče apsolutno savršeno. Sve što vam treba je šnita tostiranog kruha, vilicom zgnječeni avokado s malo limuna, dimljeni losos i kuhano jaje. Na vrh po želji možete dodati i klice, krastavac, pa čak i kavijar, no sve druge varijante također su dopuštene.',13,7);
...
INSERT INTO `storefront_sastojci` VALUES (1,'Jaja',155,NULL,0),(2,'Banana',89,NULL,0),(3,'Med',304,NULL,0),(4,'Mlijeko',42,NULL,0),(5,'Dimljeni losos',117,NULL,0),(6,'Zelena salata',15,NULL,0),(7,'Posni sir',74,NULL,0),(8,'Proteinski kruh',47,NULL,0),(9,'Gljive',22,NULL,0),(10,'Tost',313,NULL,0),(11,'Limun',29,NULL,0),(12,'Avokado',160,NULL,0),(13,'Cesnjak',4,NULL,0),(14,'Maslinovo ulje',884,NULL,0),(15,'Maslac',716,NULL,0),(16,'Sir',402,NULL,0);
...
-- Dump completed on 2022-05-23 21:01:30
